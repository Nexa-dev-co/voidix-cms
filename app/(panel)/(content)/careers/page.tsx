...
import { moveRoleAction } from "@/app/(panel)/(content)/careers/actions";
import {
  CareersForm,
  type CareersFormValues,
} from "@/app/(panel)/(content)/careers/CareersForm";
  ...
  return (
    <>
      <PageHeader
        ...
        action={
          <ButtonLink href="/careers/roles/new" variant="secondary">
            Add role
          </ButtonLink>
        }
      />
