...
import { deleteFaqAction } from "@/app/(panel)/(content)/faq/actions";
import { FaqForm } from "@/app/(panel)/(content)/faq/FaqForm";
...
export default async function EditFaqPage(props: PageProps<"/faq/[id]">) {
