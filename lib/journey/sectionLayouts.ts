...
const SECTION_LAYOUTS: SectionLayout[] = [
  {
    ...
    regions: [
      ...
      { label: "Tagline", text: "CUSTOM SOFTWARE BUILT AROUND YOUR BUSINESS", x: 38, y: 93.5, width: 24, height: 3, role: "label", align: "center" },
    ],
  },
  {
    section: "services",
    ...
    regions: [
      ...
      { label: "Section title", text: "Software built around your business.", x: 4.6, y: 16, width: 25, height: 23, role: "title" },
      ...
      { label: "Craft title", text: "Digital products built for performance and conversion", x: 76.5, y: 13, width: 19, height: 7, role: "title" },
      { label: "Craft description", text: "Business websites, web applications, SaaS products, and customer portals built around your goals.", x: 76.5, y: 21.5, width: 19, height: 12, role: "body" },
      { label: "Capability tags", text: "Websites · Web apps · SaaS", x: 76.5, y: 34, width: 19, height: 6, role: "pill" },
      { label: "Craft CTA", text: "DISCUSS THIS SERVICE →", x: 76.5, y: 43, width: 19, height: 5, role: "action", align: "center" },
      { label: "Craft strip", text: "01 Web  ·  02 Mobile  ·  03 AI  ·  04 Custom", x: 23.5, y: 88, width: 53, height: 6, role: "label", align: "center" },
    ],
  },
  {
    section: "work",
  ...
  },
  {
    ...
    regions: [
      ...
      { label: "Question panel", text: "01 What does Voidix build?\n02 Do you work across the United States?\n03 Can you build a custom CRM?\n04 Can you build a SaaS product?\n05 Can you integrate AI?", x: 29.7, y: 10, width: 41.3, height: 49, role: "body" },
  ...
  },
  {
    ...
    regions: [
      ...
      { label: "Section title", text: "Tell us what you're building.", x: 4.6, y: 38, width: 25, height: 11, role: "title" },
      { label: "Lead paragraph", text: "Tell us what it should do, who will use it, and what needs to happen when it launches.", x: 4.6, y: 47.5, width: 25, height: 8, role: "body" },
